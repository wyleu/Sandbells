#!/bin/bash
# start-kiosk-solo.sh
# Solo Kiosk with better X management

echo "=== Starting Solo Sandbells Kiosk ==="
...
echo "Launching Luakit kiosk SOLO  on sandbells.local:8000 ..."
luakit -Uu "http://sandbells.local:8000" 2>&1 | tee -a luakit.log
echo "start-kiosk-solo.sh Luakit exited . . . ."
pkill -9 luakit 2>/dev/null
